...
var Node = module.exports = function (opts, cb) {
  ...
  this.wallets = {}
  this.filter = BloomFilter.create(500, 0.001)
...
Node.prototype.createBlockStream = function (opts) {
  if (!this.peers.peers.length) throw new Error('Not connected to any peers')
  opts.peers = (opts && opts.peers) || this.peers
  opts.chain = (opts && opts.chain) || this.chain
