...
PrivateBlockHeader.prototype.toBuffer = function toBuffer () {
...
PrivateBlockHeader.prototype.toBufferWriter = function toBufferWriter (bw) {
  if (!bw) {
    bw = new BufferWriter()
  }
...
PrivateBlockHeader.prototype.validProofOfWork = function validProofOfWork () {
